#!/usr/bin/env python3
"""
Send notification to port 8766 - The proxy server port
"""
...
async def main():
    ...
    logger.info(f"Sending notification to port 8766:")
