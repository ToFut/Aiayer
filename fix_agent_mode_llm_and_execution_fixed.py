            ...
            new_section = """# Check for Universal Intelligent Automation handler first (for real LLM planning)
                        if UNIVERSAL_AVAILABLE:
                            ...
                            try:
                                ...
                                logger.info(f"✅ [STREAMING] Successfully called handle_universal_automation")
                                ...
                                logger.error(f"❌ Error calling handle_universal_automation: {e}")
...
"""
    ...
    try:
        with open("test_agent_mode_fixed.py", "w") as f:
            f.write(test_script_content)
        
        os.chmod("test_agent_mode_fixed.py", 0o755)
        logger.info("✅ Created test script: test_agent_mode_fixed.py")
    except Exception as e:
