#!/usr/bin/env python3
"""
Test overlay interface to check plan display and execute button functionality
"""
...
async def test_overlay_interface():
    """Test the overlay interface with a real plan"""
    ...
    try:
        async with websockets.connect(uri) as websocket:
            ...
            if data.get('type') == 'response' and data.get('payload', {}).get('plan_id'):
                ...
                # Step 3: Simulate overlay sending execute command
                execute_message = {
                    "type": "query",
                    "payload": {
