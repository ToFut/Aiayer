...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/llm/compatibility_ollama_service.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger('compatibility_ollama_service')

class OllamaLLM:
    def __init__(self, server_uri="ws://localhost:8765", ollama_url="http://localhost:11434"):
        self.server_uri = server_uri
        self.ollama_url = ollama_url
        self.model_name = "ollama3.2:latest"  # Use the ollama3.2:latest model
        self.running = True
        self.context_data = {}
    ...
    async def connect_to_server(self):
        ...
        while self.running:
            try:
                # Use the newer form without the path parameter
