...
class BridgeServer:
    ...
    def __init__(self, host="localhost", frontend_port=8765, backend_port=8766):
        self.host = host
    ...
    async def handler(self, websocket, path):
        ...
        try:
            ...
            self.logger.info(f"New {'frontend' if is_frontend else 'backend'} client connected at path: {path}")
    ...
    async def start(self):
        ...
        try:
            # Start frontend server with path parameter support
            ...
            # Start backend server with path parameter support
